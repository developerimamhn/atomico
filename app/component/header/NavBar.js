        ...
        <div className='fatchanimactionnavaction'>
            <header className='  mx-auto flex justify-between items-center py-[20px] sm:py-[35px] relative rounded-[80px] px-[24px] sm:px-[50px]'>
                ...
                <div className="flex justify-center items-center gap-[20px] md:gap-[26px] lg:gap-[28px] xl:gap-[30px] 2xl:gap-[32px] sm:ml-[20] md:ml-[26px] lg:ml-[28px] xl:ml-[30px] 2xl:ml-[32px]">
                    ...
                    <Link className={`Link-manu-bar text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px] xl:text-[15px] 2xl:text-[16px] flex justify-center items-center  bg-[#ffffff0d] border-b-[1px] border-b-[#ffffff66] pleacholderss
                    ${
                        isExpanded ? 'bg-[#ffffff0d] border-b-[#ffffff66] px-[10px] gap-[10px]' : 'bg-transparent border-b-transparent px-[0px] gap-[0px]'
                        }
                    `} href="#howtobuy"><Image onClick={() => setIsExpanded(!isExpanded)} className='h-[24px] w-[24px]' src={image3} alt=""/><input className={` bg-transparent focus:outline-none transition-all duration-500 ${
                    isExpanded ? 'w-[200px] h-[35px]' : 'w-[1px] h-[35px]'
                    }`} type='search' placeholder='Search'/></Link>



                    <div className='' >
                    <Link className='Link-manu-bar text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px] xl:text-[15px] 2xl:text-[16px] hidden sm:block' href="#howtobuy"><Dropdown className='hidden sm:block'/></Link>
                    </div>
                </div>
                </div>
                </nav>
