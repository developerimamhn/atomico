...
const Page3 = () => {
    return (
        <div className='bg-[#F2F4F4]'>
            <div className='container mx-auto py-[70px] sm:py-[100px] md:py-[130px] lg:py-[150px] xl:py-[170px] 2xl:py-[200px]'>
                <div className='flex flex-col justify-center items-center px-[24px] sm:px-0'>
                ...
                <div className='grid grid-cols-2 sm:grid-cols-3 gap-[1px] bg-[#E9E9E9] '>
                    <div className="bg-[#fff] p-[24px] sm:p-[20px] md:p-[25px] lg:p-[30px] xl:p-[35px] 2xl:p-[40px]">
                        ...
                        <p className='kalarna text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px] xl:text-[15px] 2xl:text-[16px] pt-[16px] lg:pt-[24px] !text-[#05181fcc] opacity-60'>The digital transformation of every industry on the planet is already well under way. </p>
                    </div>
                    <div className="bg-[#fff] p-[24px] sm:p-[20px] md:p-[25px] lg:p-[30px] xl:p-[35px] 2xl:p-[40px]">
